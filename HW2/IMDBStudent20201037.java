...
public class IMDBStudent20201037 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length != 3) {
            System.err.println("Usage: IMDBStudent20201037 <in> <out>");
            System.exit(2);
        }
        conf.setInt("topK", Integer.valueOf(otherArgs[2]));
        Job job = new Job(conf, "IMDBStudent20201037");
        job.setJarByClass(IMDBStudent20201037.class);
