...
public class YouTubeStudent20201037 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length != 3) {
            System.err.println("Usage: YoutubeStudent20201037 <in> <out>");
            System.exit(2);
        }
        conf.setInt("topK", Integer.parseInt(otherArgs[2]));
        Job job = new Job(conf, "YouTubeStudent20201037");
        job.setJarByClass(YouTubeStudent20201037.class);
