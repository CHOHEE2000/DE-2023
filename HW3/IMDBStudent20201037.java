...
public final class IMDBStudent20201037 {

    public static void main(String[] args) throws Exception {

        if (args.length < 2) {
            System.err.println("Usage: IMDBStudent20201037 <in-file> <out-file>");
            System.exit(1);
        }

        SparkSession spark = SparkSession
            .builder()
            .appName("IMDBStudent20201037")
            .getOrCreate();
		...
		String[] splt = s.split("::");
		return Arrays.asList(splt[2].split("\\|")).iterator();
            }
        };
